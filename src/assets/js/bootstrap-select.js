...
(function ($) {
  ...
  Selectpicker.DEFAULTS = {
    noneSelectedText: 'Select or Search...',
    ...
    template: {
      caret: '<a href="#"><span class="glyphicon glyphicon-menu-down"></span></a>'
    },
    maxOptions: false,
    mobile: false,
    selectOnTab: false,
    ...
    createLi: function () {
      ...
      var generateA = function (text, classes, inline, tokens) {
        return '<a tabindex="0"' +
            ...
            '>' + text +
            '<span class="' + that.options.iconBase + ' ' + that.options.tickIcon + ' check-mark color-gray"></span>' +
            '</a>';
      };
